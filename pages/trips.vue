<template>
    <div class="content">
        ...
        <ArticleSection :cells="articlesTripsReports"/>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            page: function () {
                return this.$store.state.pagetype.trip_reports
            },
            articles: function () {
                return this.$store.state.articles
            },
            articlesTripsReports: function () {
                return this.$store.state.tripReports
            } 
        },
        head () {
            return {
                title: this.$store.state.pagetype.trip_reports.title_tag,
                meta: [
                    { hid: 'description', name: 'description', content: this.$store.state.pagetype.trip_reports.description_tag }
                ]
            }
        }
    }
