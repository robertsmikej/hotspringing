...
<script>
    ...
    export default {
            ...
            pins: function (spr) {
                ...
                for (let spring in spr) {
                    ...
                    let marker = {
                        details: {
                            name: sp.name,
                            condName: sp.condensed_page_name,
                            rating: sp.rating,
        ...
        head () {
            return {
                title: this.$store.state.numOfSprings.number + " " + this.$store.state.pagetype.hotsprings.title_tag,
                meta: [
                    { hid: 'description', name: 'description', content:  this.$store.state.pagetype.hotsprings.description_tag }
                ]
            }
        }
    }
