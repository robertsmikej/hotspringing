<template>
    <div class="content">
        ...
        <ArticleSection :cells="recentArticles" v-if="sitewide.show_articles_section"/> 
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            numOfSprings: function () {
                return this.$store.state.numOfSprings
            }
        },
        head () {
            return {
                title: "Discover " + this.$store.state.numOfSprings.number + this.$store.state.pagetype.index.title_tag,
                meta: [
